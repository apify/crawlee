/**
 * Session-based cookie sharing across local browsers (Puppeteer)
 *
 * Demonstrates that the Session object transfers cookies between sequential
 * requests even when they land on different local browser instances.
 * No remote service needed.
 *
 * Setup:
 ...
 *
 * Run:
 *   npm run example:cookie-sharing-session-across-local-browsers
 */
