...
describe('dataset', () => {
    ...
    describe('remote', () => {
        ...
        test('getData() should work', async () => {
            ...
            expect(e.message).toEqual('Dataset: dataset.getData(): The response is too large for parsing. You can fix this by lowering the "limit" option.'); // eslint-disable-line max-len
            stub.restore();
        });
