...
const { EMAIL_REGEX, EMAIL_REGEX_GLOBAL, FACEBOOK_REGEX, FACEBOOK_REGEX_GLOBAL, INSTAGRAM_REGEX, INSTAGRAM_REGEX_GLOBAL, LINKEDIN_REGEX, LINKEDIN_REGEX_GLOBAL, TWITTER_REGEX, TWITTER_REGEX_GLOBAL, YOUTUBE_REGEX, YOUTUBE_REGEX_GLOBAL, TIKTOK_REGEX, TIKTOK_REGEX_GLOBAL, PINTEREST_REGEX, PINTEREST_REGEX_GLOBAL, DISCORD_REGEX, DISCORD_REGEX_GLOBAL, emailsFromText, emailsFromUrls, parseHandlesFromHtml, phonesFromText, phonesFromUrls, } = social;
describe('utils.social', () => {
    ...
    describe('LINKEDIN_REGEX', () => {
        test('works', () => {
            ...
            expect(`
                ...
                `.match(LINKEDIN_REGEX_GLOBAL)).toEqual(['https://www.linkedin.com/in/bobnewman/', 'http://ie.linkedin.com/in/alicenewman']);
    ...
    describe('INSTAGRAM_REGEX', () => {
        test('works', () => {
            ...
            expect(`
                    ...
                    `.match(INSTAGRAM_REGEX_GLOBAL)).toEqual(['https://www.instagram.com/old_prague/', 'instagr.am/old_plzen']);
    ...
    describe('TWITTER_REGEX', () => {
        test('works', () => {
            ...
            expect(`
                    ...
                    atwitter.com/bob
                    _twitter.com/bob
                    `.match(TWITTER_REGEX_GLOBAL)).toEqual(['https://www.twitter.com/apify', 'twitter.com/jack', 'twitter.com/carl123']);
    ...
    describe('FACEBOOK_REGEX', () => {
        test('works', () => {
            ...
            expect(FACEBOOK_REGEX.test('https://www.facebook.com/pages/KinEssor-Groupe-Conseil/208264345877578')).toBe(true);
            expect(FACEBOOK_REGEX.test('https://www.facebook.com/pages/category/Lawyer---Law-Firm/Delegatus-services-juridiques-inc-131011223614905/')).toBe(true);
            // Test there is just on matching group for the username
            ...
            expect('facebook.com/pages/KinEssor-Groupe-Conseil/208264345877578'.match(FACEBOOK_REGEX)[1]).toBe('pages/KinEssor-Groupe-Conseil/208264345877578');
            ...
            expect(`
                    ...
                    afacebook.com/bob
                    _facebook.com/bob
                    `.match(FACEBOOK_REGEX_GLOBAL)).toEqual(['https://www.facebook.com/someusername/', 'facebook.com/jack4567', 'fb.com/carl123']);
    ...
    describe('YOUTUBE_REGEX', () => {
        it('works', () => {
            ...
            expect(`
                    ...
                    `.match(YOUTUBE_REGEX_GLOBAL)).toEqual([
                'https://www.youtube.com/apify',
                'https://www.youtube.com/someusername',
                'youtube.com/jack4567',
                'https://www.youtube.com/watch?v=kM7YfhfkiEE',
    ...
    describe('TIKTOK_REGEX', () => {
        it('works', () => {
            ...
            expect(`
                    ...
                    `.match(TIKTOK_REGEX_GLOBAL)).toEqual([
                'https://www.tiktok.com/trending?shareId=123456789',
                'www.tiktok.com/embed/123456789/',
                'm.tiktok.com/v/123456789',
                'tiktok.com/@user',
    ...
    describe('PINTEREST_REGEX', () => {
        it('works', () => {
            ...
            expect(`
                    ...
                    `.match(PINTEREST_REGEX_GLOBAL)).toEqual([
                'https://pinterest.com/pin/123456789',
                'https://pinterest.com/pin/10084556789/',
                'https://www.pinterest.cz/pin/123456789',
                'https://www.pinterest.com/user',
    ...
    describe('DISCORD_REGEX', () => {
        it('works', () => {
            ...
            expect(`
                    ...
                    `.match(DISCORD_REGEX_GLOBAL)).toEqual([
                'https://discord.gg/discord-developers/',
                'https://discord.com/invite/jyEM2PRvMU',
                'https://discordapp.com/channels/231496023303957476/',
                'https://discord.com/channels/231496023303957476/2332823543826404586',
