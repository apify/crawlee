...
const checkHtmlToText = async (html, expectedText, hasBody = false) => {
...
describe('htmlToText()', () => {
    ...
    test('handles basic HTML elements correctly', async () => {
        ...
        await checkHtmlToText('<h1>Heading 1</h1><div><div><div><div>Deep  Div</div></div></div></div><h2>Heading       2</h2>', 'Heading 1\nDeep Div\nHeading 2');
