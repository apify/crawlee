...
describe('utils.social', () => {
            ...
            testEmailsFromText(
                ...
                easy-address@some-domain.co.uk \n\n
                 easy-address@some-domain.co.uk
                  ...
                  @also.not.an.email
                  `,
                ["this'is'also'valid'email@EXAMPLE.travel", 'easy-address@some-domain.co.uk', 'easy-address@some-domain.co.uk'],
            );
    ...
    describe('phonesFromText()', () => {
        ...
        test('extracts phones correctly', () => {
            testPhonesFromText(
                ...
                +44 7911 123456
            `,
                ['+420775123456', '+420775123456', '+420 775 123 456', '775123456', '775123456', '00420775123456', '1234567', '1234567890', '+44 7911 123456'],
            );
    ...
    describe('parseHandlesFromHtml()', () => {
        ...
        test('works', () => {
            ...
            expect(parseHandlesFromHtml(html)).toMatchObject({
                youtubes: ['https://www.youtube.com/watch?v=BsidLZKd123', 'https://www.youtube.com/watch?v=BsidLZKdYWQ'],
            });
    ...
    describe('LINKEDIN_REGEX', () => {
        test('works', () => {
            ...
            ).toEqual(['https://www.linkedin.com/in/bobnewman', 'http://ie.linkedin.com/in/alicenewman', 'linkedin.com/in/carlnewman']);
            expect(
                `
    ...
    describe('INSTAGRAM_REGEX', () => {
        test('works', () => {
            ...
            ).toEqual(['https://www.instagram.com/old_prague', 'instagram.com/old_brno', 'http://instagr.am/old_plzen']);
            expect(
                `
