...
import { CheerioCrawler, Configuration, SessionPool } from 'crawlee';
...
// v4 removed `sessionPoolOptions` from crawler options. You now have to build
// the SessionPool explicitly and pass it to the crawler so you can customize
...
const poolState = await sessionPool.getState();

server.close();

console.log('================ ISSUE 1836 — crawlee v4 ================');
