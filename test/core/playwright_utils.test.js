...
describe('playwrightUtils', () => {
    ...
    test('saveSnapshot() works', async () => {
        ...
        try {
            ...
            openKVSSpy.mockResolvedValue(object);
    ...
    describe('handleCloudflareChallenge() challenge detection', () => {
        ...
        test('detects the current challenge markup', async () => {
            ...
            await expect(handleCloudflareChallenge(page, 'https://example.com', fastOptions())).rejects.toThrow(/Blocked by Cloudflare/);
        });
        ...
        test('resolves without detection on a regular page', async () => {
            ...
            await expect(handleCloudflareChallenge(page, 'https://example.com', fastOptions())).resolves.toBeUndefined();
        });
    });
});
