...
import { createPuppeteerRouter, ProxyConfiguration, PuppeteerCrawler, puppeteerBrowserPool, RequestList, RequestQueue, RequestValidationError, Session, SessionPool, } from '@crawlee/puppeteer';
...
describe('PuppeteerCrawler', () => {
    ...
    test('should work', async () => {
        ...
        expect(puppeteerCrawler.concurrencySystem.minConcurrency).toBe(1);
