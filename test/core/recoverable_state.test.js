...
import { z } from 'zod';
import { EventType, KeyValueStore, MemoryStorageBackend, serviceLocator, StateValidationError, } from '../../packages/core/src/index.js';
...
describe('RecoverableState', () => {
    ...
    test('should handle arrays and complex objects in deep copy', async () => {
        ...
        recoverableState.currentValue.items[2].nested = 'modified';
    ...
    describe('schemas as conversions', () => {
        ...
        test('should validate on the way out when serialize is a schema', async () => {
            ...
            await recoverableState.initialize();
            recoverableState.currentValue.counter = 'not a number';
            ...
            const recoverableState = new RecoverableState({
                ...
                deserialize: {
                    '~standard': {
                        version: 1,
                        vendor: 'test',
                        validate: async (value) => ({ value: value }),
                    },
                },
            });
