...
describe('KeyValueStore', () => {
    ...
    describe('setValue', () => {
        test('throws on invalid args', async () => {
            ...
            const valueErrMsg = 'The "value" parameter must be a String, Buffer, ArrayBuffer, TypedArray, or Stream when "options.contentType" is specified';
            ...
            await expect(store.setValue('key', null, { contentType: 'image/png' })).rejects.toThrow('The "value" parameter must be a String, Buffer, ArrayBuffer, TypedArray, or Stream when "options.contentType" is specified.');
            ...
            await expect(store.setValue('key', null, { contentType: {} })).rejects.toThrow('The "value" parameter must be a String, Buffer, ArrayBuffer, TypedArray, or Stream when "options.contentType" is specified.');
            ...
            await expect(store.setValue('key', 'value', { contentType: new Date() })).rejects.toThrow(contTypeStringErrMsg);
