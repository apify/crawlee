...
export const startExpressAppPromise = async (app, port) => {
...
export async function runExampleComServer() {
    const app = express();
    ...
    (() => {
        ...
        special.post('/mock', (req, res) => {
            ...
            entries(headers).forEach(([key, value]) => res.setHeader(key, value));
        ...
        special.get('/set-cookie', (req, res) => {
            const cookieName = req.query.name || 'testCookie';
            const cookieValue = req.query.value || 'testValue';
