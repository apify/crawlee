...
import { ACT_TASK_STATUSES, ENV_VARS, APIFY_DEFAULT_PROXY_PORT, APIFY_DEFAULT_PROXY_HOSTNAME } from '../build/constants';
...
describe('Apify.getApifyProxyUrl()', () => {
    it('should work', () => {
        ...
        expect(Apify.getApifyProxyUrl({ password: 'xyz' })).to.be.eql(`http://auto:xyz@${APIFY_DEFAULT_PROXY_HOSTNAME}:${APIFY_DEFAULT_PROXY_PORT}`);
