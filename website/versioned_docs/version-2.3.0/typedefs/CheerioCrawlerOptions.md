---
id: version-2.3.0-cheerio-crawler-options
...
If set, `CheerioCrawler` will be configured for all connections to use [Apify Proxy](https://console.apify.com/proxy) or your own Proxy URLs provided
