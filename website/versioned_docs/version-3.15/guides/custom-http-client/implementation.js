...
class CustomHttpClient {
    async sendRequest(request) {
        ...
        const response = await fetch(request.url, {
            ...
            body: request.body, // TODO implement stream/generator handling
        ...
        return {
            ...
            ip: undefined,
            body: request.responseType === 'text'
                ? await response.text()
    ...
    async stream(request, onRedirect) {
        ...
        const headers = {}; // TODO same as in sendRequest()
        async function* read() {
        ...
        const response = {
            ...
            trailers: {}, // TODO not supported by fetch
            ip: undefined,
            stream: node_stream_1.Readable.from(read()),
