---
id: version-0.22.4-cheerio-crawler
...
requires JavaScript to display the content, you might need to use [`PuppeteerCrawler`](../api/puppeteer-crawler) instead, because it loads the pages
using full-featured headless Chrome browser.
