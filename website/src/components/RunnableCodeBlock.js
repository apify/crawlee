...
const CodeBlock_1 = tslib_1.__importDefault(require("@theme/CodeBlock"));
const Link_1 = tslib_1.__importDefault(require("@docusaurus/Link"));
const RunnableCodeBlock_module_css_1 = tslib_1.__importDefault(require("./RunnableCodeBlock.module.css"));
...
Make sure you are importing the code block contents with the roa-loader.`);
    ...
    if (!hash) {
        return (<CodeBlock_1.default {...props}>
                {children.code}
            </CodeBlock_1.default>);
    }
    const href = `https://console.apify.com/actors/${actor ?? EXAMPLE_RUNNERS[type ?? 'playwright']}?runConfig=${hash}&asrc=run_on_apify`;
    return (<div className={(0, clsx_1.default)(RunnableCodeBlock_module_css_1.default.container, 'runnable-code-block')}>
            <Link_1.default href={href} className={RunnableCodeBlock_module_css_1.default.button} rel="follow">
                Run on
            ...
            <CodeBlock_1.default {...props} className={(0, clsx_1.default)(RunnableCodeBlock_module_css_1.default.codeBlock, 'code-block', props.title != null ? 'has-title' : 'no-title')}>
                {children.code}
            </CodeBlock_1.default>
        </div>);
};
exports.default = RunnableCodeBlock;
