...
const CopyButton_module_css_1 = tslib_1.__importDefault(require("./CopyButton.module.css"));
function CopyButton({ copyText, compact = false, className }) {
    ...
    return <button type="button" aria-label="Copy code to clipboard" title="Copy" onClick={copy} className={(0, clsx_1.default)(className, CopyButton_module_css_1.default.copyButton, compact ? CopyButton_module_css_1.default.copyButtonCompact : CopyButton_module_css_1.default.copyButtonDefault)}>
        {copied
