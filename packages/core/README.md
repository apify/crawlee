...
- [`@crawlee/types`](https://crawlee.dev/js/api/types): holds TS interfaces mainly about the [`StorageBackend`](https://crawlee.dev/js/api/core/interface/StorageBackend)
