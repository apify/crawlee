...
export class RequestQueue implements IStorage, IRequestManager {
     ...
     *
     * Resolves to `false` when the backend does not implement per-request locking (the in-memory and
     * file-system backends never hand a request out twice anyway) or no longer holds the request locked.
     */
