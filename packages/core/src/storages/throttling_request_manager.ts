    ...
    constructor(
        ...
        ow(
            ...
            ow.object.exactShape({
                inner: ow.object,
                domains: ow.any(ow.array.ofType(ow.string.nonEmpty), ow.string.equals('all')),
                ...
                minCrawlDelaySecs: ow.optional.number.not.negative,
                throttleBy: ow.optional.string.oneOf(['hostname', 'registrableDomain']),
                maxThrottledDomains: ow.optional.number.positive,
                persistStateKey: ow.optional.string.nonEmpty,
            }),
        );
