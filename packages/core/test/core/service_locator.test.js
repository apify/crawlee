import { ApifyLogAdapter, bindMethodsToServiceLocator, Configuration, LocalEventManager, MemoryStorageBackend, ServiceConflictError, ServiceLocator, serviceLocator, } from '@crawlee/core';
import { FileSystemStorageBackend } from '@crawlee/fs-storage';
function makeMockLogger(overrides = {}) {
    const logger = {
        getOptions: () => ({}),
        setOptions: () => { },
        child: () => logger,
