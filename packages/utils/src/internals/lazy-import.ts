 ...
 * executed on first property access, call, or construction. Used internally to
 * defer expensive module loads (cheerio, ow, iconv-lite, …) until they are
 * actually needed, which significantly improves import startup time.
 *
 * @internal
 */
