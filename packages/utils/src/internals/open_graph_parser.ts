 ...
 * @param additionalProperties Any potential additional {@apilink OpenGraphProperty} items you'd like to be scraped. Currently existing properties are kept up to date.
