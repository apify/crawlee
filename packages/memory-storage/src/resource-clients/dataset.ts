...
import { createPaginatedEntryList, createPaginatedList, resolveWithinDirectory } from '../utils.js';
    ...
    implements storage.DatasetClient<Data>
{
    ...
    async update(newFields: storage.DatasetClientUpdateOptions = {}): Promise<storage.DatasetInfo> {
        ...
        this.datasetDirectory = resolveWithinDirectory(
            this.client.datasetsDirectory,
            parsed.name ?? this.name ?? this.id,
        );
