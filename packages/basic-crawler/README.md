...
New requests are only dispatched when there is enough free CPU and memory available, using the functionality provided by the [AutoscaledPool](https://crawlee.dev/js/api/core/class/AutoscaledPool) class. Concurrency is tuned via the [`minConcurrency`](https://crawlee.dev/js/api/basic-crawler/interface/BasicCrawlerOptions#minConcurrency), [`maxConcurrency`](https://crawlee.dev/js/api/basic-crawler/interface/BasicCrawlerOptions#maxConcurrency) and [`maxRequestsPerMinute`](https://crawlee.dev/js/api/basic-crawler/interface/BasicCrawlerOptions#maxRequestsPerMinute) options of the `BasicCrawler` constructor, or, for finer control, by injecting a pre-configured [`concurrencySystem`](https://crawlee.dev/js/api/basic-crawler/interface/BasicCrawlerOptions#concurrencySystem) — see [ConcurrencySystem](https://crawlee.dev/js/api/core/class/ConcurrencySystem).
