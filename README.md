...
`APIFY_LOCAL_STORAGE_DIR` or `APIFY_TOKEN` environment variable. For details, see [Environment variables](https://sdk.apify.com/docs/guides/environment-variables), [Requests storage](https://sdk.apify.com/docs/guides/requests-storage) and [Results storage](https://sdk.apify.com/docs/guides/results-storage).
