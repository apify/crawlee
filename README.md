...
- [`BasicCrawler`](https://sdk.apify.com/docs/api/basic-crawler?utm_source=github) - Provides a simple framework for the parallel
...
- [`CheerioCrawler`](https://sdk.apify.com/docs/api/cheerio-crawler?utm_source=github) - Enables the parallel crawling of a large
...
- [`PuppeteerCrawler`](https://sdk.apify.com/docs/api/puppeteer-crawler?utm_source=github) - Enables the parallel crawling of
...
- [`PuppeteerPool`](https://sdk.apify.com/docs/api/puppeteer-pool?utm_source=github) - Provides web browser tabs for user jobs
...
- [`RequestList`](https://sdk.apify.com/docs/api/request-list?utm_source=github) - Represents a list of URLs to crawl.
...
- [`RequestQueue`](https://sdk.apify.com/docs/api/request-queue?utm_source=github) - Represents a queue of URLs to crawl,
which is stored either on a local filesystem or in the [Apify Cloud](https://apify.com?utm_source=github). The queue is used
...
- [`Dataset`](https://sdk.apify.com/docs/api/dataset?utm_source=github) - Provides a store for structured data and enables their export
...
- [`KeyValueStore`](https://sdk.apify.com/docs/api/key-value-store?utm_source=github) - A simple key-value store for arbitrary data
...
- [`AutoscaledPool`](https://sdk.apify.com/docs/api/autoscaled-pool?utm_source=github) - Runs asynchronous background tasks,
...
- [`Puppeteer Utils`](https://sdk.apify.com/docs/api/puppeteer?utm_source=github) - Provides several helper functions useful
...
see the [Apify SDK Programmer's Reference](https://sdk.apify.com?utm_source=github).

## Quick Start

This short tutorial will set you up to start using Apify SDK in a minute or two.
If you want to learn more, proceed to the [Getting Started](https://sdk.apify.com/docs/guides/getting-started?utm_source=github)
...
[see the Examples section of the documentation](https://sdk.apify.com/docs/examples/basic-crawler?utm_source=github).
...
[Data storage](https://sdk.apify.com/docs/guides/data-storage?utm_source=github).
...
the [Apify Cloud](https://apify.com?utm_source=github),
you can use the [Apify command-line interface (CLI)](https://docs.apify.com/cli?utm_source=github) tool.
...
[Apify Actor](https://docs.apify.com/cli?utm_source=github) documentation.

### Usage on the Apify Cloud

You can also develop your web scraping project in an online code editor directly on the [Apify Cloud](https://apify.com/?utm_source=github).
You'll need to have an Apify Account. Go to [Actors](https://my.apify.com/actors?utm_source=github), page in the app, click <i>Create new</i>
and then go to the <i>Source</i> tab and start writing your code or paste one of the examples from the Examples section.

For more information, view the [Apify actors quick start guide](https://docs.apify.com/actor/quick-start?utm_source=github).
