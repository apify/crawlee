...
_Oh, you're back already! Let's proceed in making that scraper parallel!_
...
<CodeBlock language="js" title="src/requestQueue.mjs">
    {SharedSource}
</CodeBlock>
...
<CodeBlock language="js" title="src/routes.mjs">
    {AdaptedRoutesSource}
</CodeBlock>
...
<CodeBlock language="js" title="src/parallel-scraper.mjs">
    {ParallelScraperSource}
</CodeBlock>
