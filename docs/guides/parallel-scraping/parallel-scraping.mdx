...
- Do you plan on scraping so many pages that you need to parallelize your scraper?
  > For example, if your scraper goes across few pages, you probably don't need parallelization<br/>
...
- Do you have the resources available to run multiple scrapers in parallel?
  > When running locally, depending on your scraper type, do you have enough CPU and RAM available to sustain multiple scrapers running in parallel<br/>
