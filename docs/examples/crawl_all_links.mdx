...
If no options are given, by default the method will only add links that are under the same subdomain. This behavior can be controlled with the <ApiLink to="basic-crawler/interface/EnqueueUrlsOptions#strategy">`strategy`</ApiLink>
