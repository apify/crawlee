...
This example demonstrates how to use [`CheerioCrawler`](../api/cheeriocrawler) to crawl a list of URLs from an external file, load each URL using a
plain HTTP request, parse the HTML using <a href="https://www.npmjs.com/package/cheerio" target="_blank">cheerio</a> and extract some data from it:
