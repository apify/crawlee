...
### PuppeteerCrawler
This crawler uses a headless browser to crawl, controlled by the [Puppeteer](https://github.com/puppeteer/puppeteer) library. It can control Chromium or Chrome and has experimental support for Firefox. Puppeteer is the de-facto standard in headless browser automation.
