...
Anyway, to promote good coding practices, let's look at how you can use a <ApiLink to="basic-crawler/class/Router">`Router`</ApiLink> to better structure your crawler code.
