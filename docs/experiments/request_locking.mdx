...
As of **March 2024** (`crawlee` version `3.9.0`), this experiment is now enabled by default! With that said, if you encounter issues you can:

- set `disableRequestLocking` to `true` in the `experiments` object of your crawler options
