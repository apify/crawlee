...
declare const exportedUtils: {
    ...
    createRequestDebugInfo: (request: any, response?: import("http").IncomingMessage | import("puppeteer").Response | undefined, additionalFields?: Object | undefined) => any;
    parseContentTypeFromResponse: (response: Object) => {
        type: string;
        charset: string;
    };
} & {
    puppeteer: {
        ...
        enqueueLinks: (...args: any[]) => Promise<any[] | undefined>;
        ...
        gotoExtended: <UserData>(page: import("puppeteer").Page, request: Request<UserData>, gotoOptions?: Object) => Promise<import("puppeteer").Response>;
        addInterceptRequestHandler: (page: any, handler: import("./puppeteer_request_interception").InterceptHandler) => Promise<void>;
        removeInterceptRequestHandler: (page: any, handler: import("./puppeteer_request_interception").InterceptHandler) => Promise<void>;
