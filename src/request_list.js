...
export class RequestList {
     ...
     * @param {Array.<RequestOptions|Request>} options.sources
     ...
     * @param {RequestListState} [options.state]
...
// TODO yin: Separate @typedef RequestListOptions to share with between `new RequestList()` and `Apify.openRequestList()`
/**
