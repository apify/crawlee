...
import { ENV_VARS, EXIT_CODES, ACT_TASK_TERMINAL_STATUSES, APIFY_DEFAULT_PROXY_HOSTNAME, APIFY_DEFAULT_PROXY_PORT } from './constants';
...
export const getApifyProxyUrl = (opts = {}) => {
    const {
        ...
        hostname = process.env[ENV_VARS.PROXY_HOSTNAME] || APIFY_DEFAULT_PROXY_HOSTNAME,
        port = parseInt(process.env[ENV_VARS.PROXY_PORT], 10) || APIFY_DEFAULT_PROXY_PORT,
    } = opts;
