...
const SKIP_TAGS_REGEX = /^(script|style|canvas|svg)$/i;
const BLOCK_TAGS_REGEX = /^(p|h1|h2|h3|h4|h5|h6|ol|ul|li|pre|address|blockquote|dl|div|fieldset|form|noscript|table|tr)$/i;
