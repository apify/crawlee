 ...
 *
 * If `uniqueKey` is not provided, then for GET requests it is automatically generated by normalizing the URL.
 ...
 *
 * For other than GET requests, method and payload are included in the generated `uniqueKey`,
 * producing a `uniqueKey` in the following format: `METHOD(payloadHash):normalizedUrl`.
 *
