...
class PuppeteerCrawler {
    ...
    // TODO yin: Specify @param options.puppeteerPoolOptions type after puppeteer_pool.js
    // TODO yin: Specify @param options.launchPuppeteerFunction type after puppeteer.js@launchPuppeteerWithProxy()
    // TODO yin: Specify @param options.autoscaledPool type after autoscaling/autoscaled_pool.js
    // TODO yin: Document @param options.sessionPoolOptions
    // TODO yin: Make _defaultGotoFunction() and _defaultHandleFailedRequestFunction() resolve type
    //  like _handleRequestFunction() does (see above Function-TODOs)
    /**
